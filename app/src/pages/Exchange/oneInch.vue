<template>
    <div class="desktop-version" v-if="$q.screen.width > 1024 && depositCoin && destinationCoin">
      <div class="row">
                        ...
                        <div v-if="step === 1" class="prototype">
                          ...
                          <div class="you-pay">
                            ...
                            <div class="you-pay-body row items-center">
                               ...
                               <span class="cursor">
                                ...
                                <q-select class="select-input" light separator use-input borderless rounded v-model="depositCoin" @input="swapData.error = false; getSwapQuote()" @filter="filterDepositCoin" :disabled="!depositCoinOptions" :loading="!depositCoinOptions" :options="depositCoinOptions">
                                    ...
                                    <template v-slot:selected>
                                        {{depositCoin.value}} <q-icon name="keyboard_arrow_down" />
                                    </template>
                                </q-select>
                              ...
                              <div class="col col-6">
                                <q-input outlined class="bg-white text-h5" ref="depositQuantity" @input="swapData.error = false; getSwapQuote()" v-model="swapData.fromAmount" type="number" :disabled="spinnervisible"  :loading="spinnervisible" :rules="[ val => val > swapData.limitMinDepositCoin || 'This is less than the minimum allowed', val => val < swapData.limitMaxDepositCoin || 'This is more than the maximum allowed']">
                            ...
                            <div class="you-receive-body row items-center">
                              <div class="col col-6 choose-coin"><span class="cursor" >
                            ...
                            <div class="text-body2 text-red" v-if="approvalRequired" >
                              <span>
                              Before swaping  {{depositCoin.value}} with {{destinationCoin.value}},<br> you need to process an approval transaction
                              </span>
                            </div>
                            ...
                            <q-btn unelevated  @click="getSwapQuote()" :loading="spinnervisible" :disable="spinnervisible" color="primary" text-color="black" label="Approve token" class="text-capitalize chose_accounts full-width" />

                            <q-btn unelevated  @click="getSwapQuote()" :loading="spinnervisible" :disable="spinnervisible" color="primary" text-color="black" label="Continue" class="text-capitalize chose_accounts full-width" />
                          </div>
                        </div>

                        <div v-if="step === 3" class="prototype">
                          <div class="head">
                            <q-btn flat @click="step = 2" unelevated icon="keyboard_arrow_left" rounded color="grey" label="Back" class="--next-btn q-mr-md" />
                            Order in progress
                          </div>
                    ...
                    <q-step default title="Chose account" :name="4" prefix="4" :done="step > 4">
                      ...
                      <div class="standard-content--body">
                        <div class="standard-content--body__form">
                          ...
                          <q-select
                              v-show="destinationCoin === null || (destinationCoin.type !== 'new_public_key')"
                              light
                              separator
                              rounded
                              outlined
                      ...
                      <q-stepper-navigation v-show="true" class="flex justify-end">
                        ...
                        <div class="standard-content--footer">
                          <q-btn @click="checkAddressMatchCoins()" :disable="!disclaimerCheck" flat class="action-link next" color="black" text-color="white">
                            <span class="label">Exchange {{ depositCoin.value.toUpperCase() }} <q-icon name="keyboard_backspace" color="white" class="left-icon" /> {{ destinationCoin.value.toUpperCase() }}</span>
                          </q-btn>
                        </div>
                      </q-stepper-navigation>
                    </q-step>
    ...
    getSwapQuote () {
      ...
      this.$axios.get(swapRequestUrl)
        .then(function (result) {
          ...
          if (self.depositCoin.value.toLowerCase() !== 'eth') {
            self.isApprovalRequired(self.depositCoin.address, result.data.to, self.swapData.fromAmount)
          }
